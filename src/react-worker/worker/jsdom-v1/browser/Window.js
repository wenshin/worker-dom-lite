...
const PageTransitionEvent = require('./generated/PageTransitionEvent');
const namedPropertiesWindow = require('./named-properties-window');
const postMessage = require('./post-message');
const DOMException = require('domexception/webidl2js-wrapper');
const { btoa, atob } = require('abab');
const idlUtils = require('./generated/utils');
const WebSocketImpl = require('./websockets/WebSocket-impl').implementation;
const BarProp = require('./generated/BarProp');
const documents = require('./documents.js');
const External = require('./generated/External');
const Navigator = require('./generated/Navigator');
const Performance = require('./generated/Performance');
const Screen = require('./generated/Screen');
const Storage = require('./generated/Storage');
const Selection = require('./generated/Selection');
const reportException = require('./helpers/runtime-script-errors');
const { fireAnEvent } = require('./helpers/events');
const SessionHistory = require('./window/SessionHistory');
const {
  forEachMatchingSheetRuleOfElement,
  getResolvedValue,
  propertiesWithResolvedValueImplemented
} = require('./helpers/style-rules');
const CustomElementRegistry = require('./generated/CustomElementRegistry');
