...
const serializationAdapter = require('./domparsing/parse5-adapter-serialization');
const { customElementReactionsStack, invokeCEReactions, lookupCEDefinition } = require('../../helpers/custom-elements');
...
function parseFragment(markup, contextElement) {
  const ownerDocument =
    contextElement.localName === 'template' ? contextElement.content._ownerDocument : contextElement._ownerDocument;
