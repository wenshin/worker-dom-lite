...
exports.isDisabled = (formControl) => {
  if (
    formControl.localName === 'button' ||
    formControl.localName === 'input' ||
    formControl.localName === 'select' ||
...
exports.isSubmitButton = (formControl) => {
  return (
    ((formControl._localName === 'input' && submitButtonInputTypes.has(formControl.type)) ||
...
exports.isButton = (formControl) => {
  return (
    ((formControl._localName === 'input' && buttonInputTypes.has(formControl.type)) ||
