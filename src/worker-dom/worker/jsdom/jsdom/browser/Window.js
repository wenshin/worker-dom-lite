...
function Window(options) {
  ...
  this.$ipcObjectManager = options.ipcObjectManager;
  this.$cargo = this.$ipcObjectManager.addSource('Window', this);
  ...
  this._document = documents.createWrapper(
    window,
    {
      ...
      ipcObjectManager: options.ipcObjectManager,
  ...
  define(this, {
    get setTimeout() {
      return self.setTimeout.bind(self); // eslint-disable-line no-restricted-globals
    },
    get clearTimeout() {
      return self.clearTimeout.bind(self); // eslint-disable-line no-restricted-globals
    },
    get setInterval() {
      return self.setInterval.bind(self); // eslint-disable-line no-restricted-globals
    },
    get clearInterval() {
      return self.clearInterval.bind(self); // eslint-disable-line no-restricted-globals
    },
    get requestAnimationFrame() {
      return self.requestAnimationFrame.bind(self); // eslint-disable-line no-restricted-globals
    },
    get cancelAnimationFrame() {
      return self.cancelAnimationFrame.bind(self); // eslint-disable-line no-restricted-globals
    },
    // get length() {
    ...
    get location() {
      ...
      // for react-dom dev version
      return self.location; // eslint-disable-line no-restricted-globals
    },
    // get history() {
    //   return idlUtils.wrapperForImpl(idlUtils.implForWrapper(window._document)._history);
    // },
    get navigator() {
      return self.navigator; // eslint-disable-line no-restricted-globals
    },
    // get locationbar() {
    //   return locationbar;
    // },
    ...
    // },
    get performance() {
      return self.performance; // eslint-disable-line no-restricted-globals
    },
    // get screen() {
    //   return screen;
    // },
    get origin() {
      return self.origin; // eslint-disable-line no-restricted-globals
    },
  ...
  this.postMessage = self.postMessage; // eslint-disable-line no-restricted-globals
  ...
  this.getComputedStyle = function(elt) {
    const elem = elt[idlUtils.implSymbol] || elt;
    return elem._$computedStyles;
  };
